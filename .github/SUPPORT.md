# Getting help with AllSideR

Thanks for using AllSideR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/AllSideR/issues) to make sure the 
